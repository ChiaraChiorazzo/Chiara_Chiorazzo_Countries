...
const Form = () => {
    ...
    useEffect(() => { dispatch(getTotalityOfCountries()) 
    ...
    console.log("Estado local del form:", newActivity, "Estado local de Errores", errors, "Countries selected", selectedCountries)
...
console.log("input", inputRefCountryToDelete)
   ...
   const handlesubmit = (event)=>{
    ...
    if(arrayErrors.length||!newActivity.name) {alert ("Activity not created, check errors in the form")
}else{
                        ...
                        countriesSelectedInfo?.map(country => {
                            return <>
                             <div className={style.containerNameFlag}>
                                ...
                                {/* input used for saving wich country will be removed */}
                                <input type="text" value={country.name}  ref={inputRefCountryToDelete}  hidden/>
                                <p className={style.flagName}>{country.id}</p>
                                <button className={style.flagButton}onClick={handleOnClickFlag}>X</button>
